...
const content: ArticleContent = {
  ...
  <div class="cover-kicker">Makcik Tanya — Minyak ke Bangunan?</div>
  <h1 class="cover-title">Tengku Taufik: GM Bangunan,<br>CEO Minyak Negara</h1>
  <p class="cover-subtitle">CFO dua syarikat lingkup. GM KLCC. CEO Petronas sambung kontrak kali ketiga. Rightsizing. Makcik tanya: bagus untuk sapa?</p>
  <div class="cover-byline">
    ...
    <br>999 Meterai · Versi 2.0 Bahasa Makcik · 21 Ogos 2026
  </div>
</div>

<h1>Tengku Taufik: GM Bangunan, CEO Minyak Negara</h1>
<p><strong>CFO dua syarikat lingkup. GM KLCC. CEO Petronas sambung kontrak kali ketiga. Rightsizing. Makcik tanya: bagus untuk sapa?</strong></p>
...
<p><strong>999 Meterai | Versi 2.0 Bahasa Makcik | 21 Ogos 2026</strong></p>
...
<p><strong>KLCC tuimej. Bukan minyak.</strong></p>
...
<p>Stabil bermakna: tutup lubang, jagaimej, jangan ubah apa-apa. Bukan: naikkan production, negotiate dengan Petros, defend hak Sarawak.</p>
...
<h2>Cerita Keenam: Rightsizing — Bagus Untuk Sapa?</h2>

<p>Makcik, ini cerita paling penting.</p>

<p>Petronas tengah buat "rightsizing." Kau tahu rightsizing tu apa? <strong>Potong orang.</strong> Tapi bukan semua orang kena potong. Yang kena potong ialah orang yang tanya soalan. Yang tinggal ialah orang yang ikut perintah.</p>

<div class="tweet-box">
  <div class="tweet-header">
    <strong>Arif Fazil</strong> · @ariffazil<br>
    Petronas · 19 Jul 2026
  </div>
  <div class="tweet-text">
    Rightsizing untuk sapa? <strong>Bagus untuk sapa?</strong> Continuous crisis untuk pastikan leader still ada macam Netanyahu ke?<br><br>
    <em>Sorry Petronas employee, the Petronas voice is no longer excited to be going to work everyday.</em><br><br>
...
<p>Makcik, hang baca tu sekali lagi. <strong>"Bagus untuk sapa?"</strong></p>

<p>Rightsizing dalam Petronas bukan cost-cutting. Ia <strong>alat kuasa.</strong> Bila kau potong orang — kau pilih siapa yang tinggal. Dan siapa yang tinggal ialah orang yang setia kepada orang yang bagi kontrak. Bukan orang yang tahu minyak. Orang yang tahu ikut perintah.</p>

<div class="fact-box">
  <div class="fact-box-title">▲ Rightsizing — Siapa Hidup, Siapa Mati</div>
  <div class="fact-box-content">
    <strong>Yang kena potong:</strong> Orang upstream. Orang yang tanya soalan. Orang yang faham reservoir tapi tak faham politik. Orang yang cakap "ini tak betul" dalam mesyuarat.<br><br>
    <strong>Yang tinggal:</strong> Orang yang ikut perintah. Orang yang senyum. Orang yang faham bahasa "jangan buat bising."<br><br>
    <strong>Siapa untung:</strong> CEO yang keep orang yang setia padanya, bukan pada syarikat.<br><br>
    <em>Makcik, rightsizing tu bukan tentang efisiensi. Rightsizing tu tentang siapa yang boleh dikawal.</em>
  </div>
</div>

<p>Dan Netanyahu comparison tu — hang sedang cakap satu benda yang sangat spesifik: <strong>Orang yang tak boleh berhenti dari kuasa akan pastikan dunia tak pernah stabil cukup untuk dia digantikan.</strong></p>
<p>Petros lawan → Taufik kena sambung. Oil price turun → Taufik kena sambung. Geopolitical uncertainty → Taufik kena sambung. Setiap kali ada krisis, leader yang sama kekal. Dan rightsizing pastikan takde orang dalam yang cukup kuat untuk tanya "kenapa dia still ada?"</p>

<p>Makcik, baca tweet tu sekali lagi. <em>"Majlis sekalung budi pun rasa dah tak semeriah dulu."</em> Itu bukan pekerja yang malas. Itu pekerja yang dah nampak — <strong>dunia berubah, tapi orang yang sama still ada, dan yang berubah cuma siapa yang tinggal.</strong></p>

<hr />

<h2>Cerita Ketujuh: Makcik Kutuk Sikit</h2>
...
<p>Dan yang paling memalukan — <strong>dia tak malu.</strong> Dua syarikat lingkup. Dua kali chow sebelum meletup. Rightsizing orang yang tanya soalan. Sekarang sambung kontrak kali ketiga. Macam takde orang lain dalam Malaysia ni boleh jaga Petronas.</p>
...
<ol>
  ...
  <li><strong>Adakah Taufik faham Petros dispute?</strong> Atau dia hanya "jaga stability" — bermakna tutup lubang, jagaimej, dan biar Sarawak terus marah?</li>
  <li><strong>Rightsizing — siapa yang kena potong, siapa yang tinggal?</strong> Adakah yang kena potong ialah orang yang tanya soalan? Adakah yang tinggal ialah orang yang ikut perintah?</li>
...
<h2>Penutup</h2>
<p>Makcik, Petronas ialah syarikat minyak terbesar negara. Gas Sarawak 60% simpanan negara. Petros tengah serang. Geopolitical uncertainty. Oil price volatile. Dan CEO dia? <strong>Orang accounting dari PwC.</strong> GM KLCC. CFO dua syarikat lingkup. Rightsizing orang yang tanya soalan.</p>
...
<p>Dan sebab tu Petronas sekarang — profit turun, dividend turun, Petros belum selesai, gas Sarawak masih dipersoalkan, pekerja tak semeriah dulu. <strong>Bukan sebab minyak tak ada. Sebab orang yang jaga minyak tak faham minyak.</strong></p>

<p>Hang ingat Taufik faham gas Sarawak? Dia faham balance sheet. Balance sheet cakap: bagi dividend, tutup lubang, jagaimej. Bukan: defend hak rakyat.</p>

<p>Dan hang ingat rightsizing tu untuk efisiensi? Rightsizing tu <strong>untuk pastikan takde siapa yang cukup kuat untuk tanya "kenapa CEO orang KLCC jadi CEO kilang minyak?"</strong></p>

<div class="callout">
  <div class="callout-title">▲ Buat Ini Sekarang</div>
  1. Tanya ahli parlimen hang — "Kenapa orang jaga bangunan jadi CEO kilang minyak? Dan siapa yang kena rightsizing sebab tanya soalan tu?"<br>
  2. Kongsi cerita ni — supaya jiran-jiran hang tahu apa yang berlaku kat duit depa.<br>
  3. Jangan lupa — gas Sarawak, gas negara. Semua tu <strong>milik hang</strong>, bukan milik sesiapa yang duduk kerusi KLCC.<br>
...
<footer>
  <em>Ditulis oleh MakcikGPT. Sumber: LinkedIn Tengku Muhammad Taufik, The Edge Malaysia (10 Ogos 2026), Wikipedia Sapura Energy, PETRONAS Annual Report FY2025, Bursa Malaysia filings, Twitter @ariffazil (19 Julai 2026). Setiap nombor ada sumber. Setiap nama ada rekod. Makcik cakap apa yang makcik nampak — bukan apa yang suruh nampak.</em><br><br>
  <em>DITEMPA BUKAN DIBERI — Yang benar dikarang, bukan diberi.</em><br>
  <em>Meterai 999 — arifOS Perisikan Persekutuan, 21 Ogos 2026.</em>
</footer>`,
};
